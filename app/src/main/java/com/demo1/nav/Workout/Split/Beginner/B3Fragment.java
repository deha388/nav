...
public class B3Fragment extends Fragment {
   ...
   Button Next1;
    ...
    public static B3Fragment newInstance() {
        return new B3Fragment();
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        View view=inflater.inflate(R.layout.b3_fragment,container,false);
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        btnexercise.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                fragmentTransaction.replace(R.id.ada,new B4Fragment());
